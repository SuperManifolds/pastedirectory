...
error_controller = Blueprint('error_controller', 'error_controller',
...
@error_controller.app_errorhandler(405)
def page_not_found(error):
	return render_template('errors/405.html'), 405

@error_controller.app_errorhandler(406)
def page_not_found(error):
	return render_template('errors/406.html'), 406

@error_controller.app_errorhandler(408)
def page_not_found(error):
	return render_template('errors/408.html'), 408

@error_controller.app_errorhandler(409)
def page_not_found(error):
	return render_template('errors/409.html'), 409

@error_controller.app_errorhandler(410)
def page_not_found(error):
	return render_template('errors/410.html'), 410

@error_controller.app_errorhandler(411)
def page_not_found(error):
	return render_template('errors/411.html'), 411

@error_controller.app_errorhandler(412)
def page_not_found(error):
	return render_template('errors/412.html'), 412

@error_controller.app_errorhandler(413)
def page_not_found(error):
	return render_template('errors/413.html'), 413

@error_controller.app_errorhandler(414)
def page_not_found(error):
	return render_template('errors/414.html'), 414

@error_controller.app_errorhandler(415)
def page_not_found(error):
	return render_template('errors/415.html'), 415

@error_controller.app_errorhandler(416)
def page_not_found(error):
	return render_template('errors/416.html'), 416

@error_controller.app_errorhandler(417)
def page_not_found(error):
	return render_template('errors/417.html'), 417

@error_controller.app_errorhandler(418)
def page_not_found(error):
	return render_template('errors/418.html'), 418

@error_controller.app_errorhandler(426)
def page_not_found(error):
	return render_template('errors/426.html'), 426

@error_controller.app_errorhandler(428)
def page_not_found(error):
	return render_template('errors/428.html'), 428

@error_controller.app_errorhandler(429)
def page_not_found(error):
